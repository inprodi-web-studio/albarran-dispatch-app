                      ...
                      if (!(isWeb
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Ingresa con tus credenciales para comenzar a despachar.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.poppins(
                              ...
                              children: [
                                ...
                                FlutterFlowChoiceChips(
                                  options: [
                                    ...
                                    ChipData('El Arenal'),
                                    ChipData('Calzada'),
                                    ChipData('López Mateos'),
                                    ChipData('Bohemio')
                                  ],
                                  onChanged: (val) => safeSetState(() =>
                                      _model.branchValue = val?.firstOrNull),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.loginOutput =
                                    ...
                                    branch: () {
                                      if (_model.branchValue == 'Alamo') {
                                        return 'alamo';
                                      } else if (_model.branchValue ==
                                          'El Arenal') {
                                        return 'arenal';
                                      } else if (_model.branchValue ==
                                          'Calzada') {
                                  ...
                                  if ((_model.loginOutput?.succeeded ?? true)) {
                                    ...
                                    context.goNamedAuth(
                                      SelectBombPageWidget.routeName,
                                      context.mounted,
                                    ...
                                    if ((_model.loginOutput?.statusCode ??
                                            200) ==
                                        400) {
                                      if (AuthGroup.loginCall.errorKey(
                                            (_model.loginOutput?.jsonBody ??
                                                ''),
                                          ) ==
                                          'auth.blocked') {
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                  'Parece que tu cuenta ha sido desactivada. Por favor, contacta a un administrador.'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: Text('Accesos Incorrectos'),
                                            content: Text(
                                                'Los accesos ingresados son incorrectos'),
                                            actions: [
                                              TextButton(
